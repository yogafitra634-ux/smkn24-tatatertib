...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="kelola-siswa.php" class="nav-item <?= $active_page==='siswa'?'active':'' ?>">
            <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
            Kelola Siswa
        </a>
        <a href="kelola-operator.php" class="nav-item <?= $active_page==='operator'?'active':'' ?>">
            <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
            Kelola Operator
        </a>
        <a href="kelola-pelanggaran.php" class="nav-item <?= $active_page==='pelanggaran'?'active':'' ?>">
        ...
        <a href="kelola-tata-tertib.php" class="nav-item <?= $active_page==='tatatertib'?'active':'' ?>">
